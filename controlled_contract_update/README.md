...
# will output bytecode sha2-256 digest: EiCvMe3JkcxGTwpmoZGTBL17UVThpx7jE3jXOgoEZEVd5Q==

# register the contract in your CLI, for example: 
register update 16FKPtL9h7FHwFogcCgWV9okXaQPNZKniG

# call the allow_sha256 function with the digest calculated above
update.allow_sha256 EiCvMe3JkcxGTwpmoZGTBL17UVThpx7jE3jXOgoEZEVd5Q==

# try to update the contract again...
contract bytecode was successfully updated: digest EiCvMe3JkcxGTwpmoZGTBL17UVThpx7jE3jXOgoEZEVd5Q==
```